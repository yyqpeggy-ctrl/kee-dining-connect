  ...
  return (
    <div className="space-y-6 mt-6">
      ...
      <Tabs defaultValue="poster" className="space-y-4" onValueChange={(tab) => {
        ...
        {/* Video Edit - Professional Workspace */}
        <TabsContent value="video">
          <VideoEditorWorkspace
            ...
            handleImageUpload={handleImageUploadWithAnalyze}
            removeVideo={removeVideo}
            removeImage={removeImage}
            videoStyles={videoStyles}
            videoTemplates={videoTemplates}
            selectedVideoStyle={selectedVideoStyle}
            setSelectedVideoStyle={setSelectedVideoStyle}
            ...
            setGeneratedSubtitles={setGeneratedSubtitles}
