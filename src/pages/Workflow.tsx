...
import { GitBranch, Play, Pause, Plus, CheckCircle, Clock, AlertTriangle } from "lucide-react";
...
const Workflow = () => {
  ...
  const workflows = [
    {
      id: 1,
      name: isZh ? "采购审批流程" : "Procurement Approval",
      status: "active",
      steps: 4,
      pending: 2,
      completed: 12,
    ...
    {
      id: 2,
      name: isZh ? "请假审批流程" : "Leave Approval",
      status: "active",
      steps: 3,
      pending: 1,
      completed: 28,
    ...
    {
      id: 3,
      name: isZh ? "合同签署流程" : "Contract Signing",
      status: "paused",
      steps: 5,
      pending: 0,
      completed: 6,
    ...
    {
      id: 4,
      name: isZh ? "费用报销流程" : "Expense Reimbursement",
      status: "active",
      steps: 3,
      pending: 5,
      completed: 45,
